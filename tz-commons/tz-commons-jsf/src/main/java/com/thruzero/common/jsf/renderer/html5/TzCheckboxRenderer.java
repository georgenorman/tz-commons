...
/**
 * Adds configurable pass-through attributes to the TzCheckbox component.
 *
 * @author George Norman
 */
@FacesRenderer(componentFamily = JsfHtml5Component.COMPONENT_FAMILY, rendererType = TzCheckboxRenderer.RENDERER_TYPE)
public class TzCheckboxRenderer extends CheckboxRenderer {
  public static final String RENDERER_TYPE = JsfHtml5Component.COMPONENT_FAMILY + ".TzCheckboxRenderer";

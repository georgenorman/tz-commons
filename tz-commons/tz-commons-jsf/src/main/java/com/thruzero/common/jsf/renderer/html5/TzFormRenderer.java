...
/**
 * Adds configurable pass-through attributes to the TzForm component.
 *
 * @author George Norman
 */
@FacesRenderer(componentFamily = JsfHtml5Component.COMPONENT_FAMILY, rendererType = TzFormRenderer.RENDERER_TYPE)
public class TzFormRenderer extends FormRenderer {
  public static final String RENDERER_TYPE = JsfHtml5Component.COMPONENT_FAMILY + ".TzFormRenderer";

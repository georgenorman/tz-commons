...
/**
 * Adds configurable pass-through attributes to the TzTextarea component.
 *
 * @author George Norman
 */
@FacesRenderer(componentFamily = JsfHtml5Component.COMPONENT_FAMILY, rendererType = TzTextareaRenderer.RENDERER_TYPE)
public class TzTextareaRenderer extends TextareaRenderer {
  public static final String RENDERER_TYPE = JsfHtml5Component.COMPONENT_FAMILY + ".TzTextareaRenderer";

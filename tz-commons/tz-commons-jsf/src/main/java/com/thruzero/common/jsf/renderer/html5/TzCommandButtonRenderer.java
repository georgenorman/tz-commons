...
/**
 * Adds configurable pass-through attributes to the TzCommandButton component.
 *
 * @author George Norman
 */
@FacesRenderer(componentFamily = JsfHtml5Component.COMPONENT_FAMILY, rendererType = TzCommandButtonRenderer.RENDERER_TYPE)
public class TzCommandButtonRenderer extends ButtonRenderer {
  public static final String RENDERER_TYPE = JsfHtml5Component.COMPONENT_FAMILY + ".TzCommandButtonRenderer";

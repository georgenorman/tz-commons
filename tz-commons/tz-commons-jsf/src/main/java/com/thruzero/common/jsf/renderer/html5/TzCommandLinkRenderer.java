...
/**
 * Adds configurable pass-through attributes to the TzCommandLink component.
 *
 * @author George Norman
 */
@FacesRenderer(componentFamily = JsfHtml5Component.COMPONENT_FAMILY, rendererType = TzCommandLinkRenderer.RENDERER_TYPE)
public class TzCommandLinkRenderer extends CommandLinkRenderer {
  public static final String RENDERER_TYPE = JsfHtml5Component.COMPONENT_FAMILY + ".TzCommandLinkRenderer";

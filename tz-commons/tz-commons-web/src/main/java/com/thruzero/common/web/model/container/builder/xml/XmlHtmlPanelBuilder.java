...
public class XmlHtmlPanelBuilder extends AbstractXmlPanelBuilder {
  ...
  public AbstractPanel build() throws Exception {
    ...
    HtmlPanel result = new HtmlPanel(getPanelId(), getPanelTitle(), getPanelTitleLink(), getCollapseDirection(), isUseWhiteChevron(), getPanelHeaderStyleClass(), getToolbar(), content);

...
/**
 * An instance represents an "absolute" path to a single entity in a data store, where the ROOT data store path is
...
public class EntityPath implements Serializable, Cloneable {
  ...
  public EntityPath(String entityPath) {
    ...
    containerPath = new ContainerPath(StringUtils.isEmpty(containerPathAsString) ? ContainerPath.CONTAINER_PATH_SEPARATOR : containerPathAsString);

...
/**
 * Unit test for HibernatePreferenceDAO.
 */
public class HibernatePreferenceDAOTest extends AbstractDomainHibernateTestCase {
  private AbstractPreferenceDAOTestHelper testHelper = new HibernatePreferenceDAOTestHelper();

  // -----------------------------------------------
  // HibernatePreferenceDAOTestHelper
  // -----------------------------------------------

  public class HibernatePreferenceDAOTestHelper extends AbstractPreferenceDAOTestHelper {
  ...
  public void testLocatePreferenceDAO() {
    ...
    assertTrue(dao != null);
    assertTrue(dao.getClass().equals(HibernatePreferenceDAO.class)); // make sure the locator is configured properly
  }

...
import com.thruzero.domain.hibernate.dao.HibernateSettingDAO;
 ...
 */
public class HibernateSettingServiceTest extends AbstractDomainHibernateTestCase {
  private AbstractSettingServiceTestHelper testHelper = new HibernateSettingServiceTestHelper();

  // ------------------------------------------------------
  // HibernateSettingServiceTestHelper
  // ------------------------------------------------------

  public class HibernateSettingServiceTestHelper extends AbstractSettingServiceTestHelper {
  ...
  public void testLocateSettingService() {
    ...
    assertTrue(((GenericSettingService)service).getSettingDAOClassName().equals(HibernateSettingDAO.class.getName())); // make sure the locator is configured properly
  }

 ...
 */
public class HibernateUserDAOTest extends AbstractAuthHibernateTestCase {
  private final AbstractUserDAOTestHelper testHelper = new HibernateUserDAOTestHelper();

  // ------------------------------------------------------
  // HibernateUserDAOTestHelper
  // ------------------------------------------------------

  public class HibernateUserDAOTestHelper extends AbstractUserDAOTestHelper {
  ...
  public void testLocateUserDAO() {
    ...
    assertTrue(dao != null);
    assertTrue(dao.getClass().equals(HibernateUserDAO.class)); // make sure the locator is configured properly
  }
